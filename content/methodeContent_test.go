...
var validStory = EomFile{
	...
	"EOM::Story",
	contentWithHeadline,
	supportedCompoundStorySourceCodeAttributes,
	systemAttributesValidChannel,
}
...
var supportedSourceCodeStory = EomFile{
	...
	"EOM::Story",
	"value",
	supportedStorySourceCodeAttributes,
	"systemAttributes",
}
